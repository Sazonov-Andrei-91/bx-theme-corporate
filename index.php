...
<!--                                <li>-->
<!--                                    <img src="--><?//=WFM_TEMPLATE_PATH ?><!--/images/1.jpg" class="img-responsive" alt="">-->
<!--                                    <div class="caption">-->
...
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <img src="--><?//=WFM_TEMPLATE_PATH ?><!--/images/4.jpg" class="img-responsive" alt="">-->
<!--                                    <div class="caption">-->
...
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <img src="--><?//=WFM_TEMPLATE_PATH ?><!--/images/5.jpg" class="img-responsive" alt="">-->
<!--                                    <div class="caption">-->
...
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <img src="--><?//=WFM_TEMPLATE_PATH ?><!--/images/6.jpg" class="img-responsive" alt="">-->
<!--                                    <div class="caption">-->
...
$arFilter = Array("IBLOCK_ID" => 3, "ACTIVE_DATE" => "Y", "ACTIVE" => "Y", "!SHOW_MAIN" => false);
        ...
        <?php while($ob = $res->GetNextElement()): $arFields = $ob->GetFields(); ?>
            ...
            ?>
                <div class="col-md-6 nam-matis-1">
                    ...
                    <p><?=mb_strimwidth($arFields['PREVIEW_TEXT'], 0, 125, '...')?></p>
                </div>
            <?php if($i % 2 == 1): ?>
