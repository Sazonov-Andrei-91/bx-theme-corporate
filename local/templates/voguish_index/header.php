...
<head>
    ...
    <?php
    Asset::getInstance()->addCss(WFM_TEMPLATE_PATH . "/css/bootstrap.css");
    Asset::getInstance()->addCss(WFM_TEMPLATE_PATH . "/css/style.css");
    ...
    Asset::getInstance()->addString('    <meta name="keywords" content="Voguish Responsive web template, Bootstrap Web Templates, Flat Web Templates, Andriod Compatible web template,
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />');


    CJSCore::Init(['jquery']);
    Asset::getInstance()->addJs(WFM_TEMPLATE_PATH . "/js/responsiveslides.min.js");
    Asset::getInstance()->addJs(WFM_TEMPLATE_PATH . "/js/jquery.flexisel.js");
    ?>
